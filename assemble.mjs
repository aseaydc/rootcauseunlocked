  ...
  for (const c of COPIES) {
    ...
    if (!FORCE) {
      ...
      if (srcStat && destStat && destStat.mtimeMs > srcStat.mtimeMs) {
        console.warn(
          `SKIPPED: ${c.dest}/index.html is newer than root ${c.src}. The deployed ` +
          `page has edits the source does not. Reconcile them into the root file, ` +
          `or rerun with --force to discard the deployed version.`
        );
        skipped++;
        continue;
      }
